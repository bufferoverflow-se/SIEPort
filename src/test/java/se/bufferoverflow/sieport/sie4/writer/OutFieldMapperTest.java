...
class OutFieldMapperTest {
    ...
    @Test
    void testToFileString_OrgNr_withBothAcqNoAndActNo() {
        SIE4Item.OrgNr item = new SIE4Item.OrgNr("556334-3689", Optional.of(1), Optional.of(2));

        String result = OutFieldMapper.toFileString(item);
        assertThat(result).isEqualTo("#ORGNR 556334-3689 1 2");
    }
